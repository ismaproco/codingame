...
import { Plotter } from './util/Plotter';
...
function render() {
  ...
  // drawLine(50, 50, 600, 500);
  var plot = new Plotter(ctx, 100, 100, 1000, 500);
  var arr = P.getAceleratedMovement(0, 4, 200);
  var arr2 = P.getAceleratedMovement(0, 0.5, 200);
  var arr3 = P.getAceleratedMovement(0, 0.9, 200);

  plot.render( arr, arr2, arr3 );
